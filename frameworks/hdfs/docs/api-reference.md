...
CLI Example
```bash
$ $cli-package-name --name=hdfs pod list
```
...
CLI Example
```bash
$ $cli-package-name pod info --name=hdfs journal-0
```
...
CLI Example
```bash
$ $cli-package-name --name=hdfs pod replace <node-id>
```
...
CLI Example
```bash
$ $cli-package-name pod --name=hdfs restart <node-id>
```
...
CLI Example
```bash
$ $cli-package-name config --name=hdfs target
```
...
CLI Example
```bash
$ $cli-package-name config --name=hdfs list
```
...
CLI Example
```bash
$ $cli-package-name config --name=hdfs show 9a8d4308-ab9d-4121-b460-696ec3368ad6
```
